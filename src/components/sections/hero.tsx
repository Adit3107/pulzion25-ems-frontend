...
export default function Hero() {
  return (
    <AnimatedSection id="home" className="relative container grid lg:grid-cols-1 gap-10 items-center justify-center min-h-[calc(100vh-10rem)] pt-16 overflow-hidden">
      <motion.div 
